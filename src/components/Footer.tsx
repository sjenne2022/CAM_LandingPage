...
useEffect(() => {
    ...
    { opacity: 0, y: 50 },
    {
        opacity: 1,
        y: 0,
        duration: 1.5, // Slower animation for better visibility
...
return (
    <footer ref={footerRef} className="bg-green-900 text-white py-16 px-6 sm:px-16">
    <div className="max-w-7xl mx-auto flex flex-col gap-16">
        ...
        <a
            ...
            className="text-xl sm:text-6xl font-bold underline underline-offset-4 transition-all duration-300 block hover:tracking-wider"
        >
